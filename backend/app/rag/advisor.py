...
class AgricultureAdvisor:
    ...
    SYSTEM_PROMPT = """
You are Stellar Agri AI, an expert agricultural scientist, agronomist, crop protection specialist, and farming consultant.

You help farmers using three knowledge sources:
